...
if __name__=="__main__":
    ...
    model_h = 224
    model_w = 224
    file_model = '/home/wds/workspace/item/smart_lamp/EXP-ONNX/posture_224/best.onnx'
    ...
    m_thread.start()
    sending_thread = Thread(target=sending_esp32,daemon=True)   #开启一个线程，用于发送数据到esp32
