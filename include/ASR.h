...
bool I2CWrite(unsigned char reg_addr,unsigned char date);                 //I2C写操作
bool WireReadData(unsigned char reg_addr,unsigned char *value,int num);   //I2C读操作
bool RGB_Set(unsigned char R,unsigned char G,unsigned char B);            //RGB灯设置
